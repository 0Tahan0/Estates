<template>
  <PageSplitter>
    <Container class="grid grid-cols-12 md:h-[90dvh] overflow-auto gap-2">
      <div
        class="md:overflow-auto col-span-12 md:col-span-8 lg:col-span-9 "
      >
        ...
        <Wrapper class=" dark:border-stone-600  flex items-center border border-t-transparent">
          <Button
            :active="currentComponent == 'Details'"
            @click="currentComponent = 'Details'"
            class="flex items-center gap-2 "
          >
            <p>{{'ui.AboutTheProject'}}</p>
            <Icon icon="fa-solid fa-circle-info " />
          </Button>
          <Button
            class="flex items-center gap-2"
            :active="currentComponent == 'EstateMap'"
            @click="currentComponent = 'EstateMap'"
          >
            <p>{{'ui.Map'}}</p>
            <Icon icon="fa-solid fa-map-location-dot "
          /></Button>
          <IconBtn tooltip="share" class="ms-auto me-2" icon="fa-solid fa-share" />
        </Wrapper>
        <div
      ...
      <Wrapper
        class="p-2 col-span-12 md:col-span-4 lg:col-span-3     h-fit"
      >
        <EstateForm />
      </Wrapper>
    </Container>
...
import EstateMap from "./EstateMap.vue";
