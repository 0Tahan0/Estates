<template>
  <div class="relative w-full h-full">
    ...
    <div v-if="control" class="absolute bottom-5 right-2.5 z-30 grid gap-1">
      <IconBtn
...
export default {
  ...
  methods: {
    ...
    // handelPointRightClick() {
    //   this.deleteMode = false;
    //   this.pointingMode = false;
    // },
    handelPointSet(e, point) {
      if (this.pointingMode) {
        const location = e.lngLat;
        this.createPoint({ location: [location.lng, location.lat] });
